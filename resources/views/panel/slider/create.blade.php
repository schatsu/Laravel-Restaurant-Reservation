        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="row g-3" method="post" action="{{route('slider.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-6">
                        <label for="inputTitle" class="form-label">Başlık<span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sub_title" value="{{old('sub_title')}}" class="form-control" id="inputSubTitle">
                    </div>
                    <div class="col-md-6">
                        <label for="inputSlider" class="form-label">Slider<span class="text-danger">*</span></label>
